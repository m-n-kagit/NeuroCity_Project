...
print("CUDA Version:", torch.version.cuda if torch.version.cuda else "Not available")
...
def simulation_feed():
    from Traffic_simulation.simulation2 import generate_simulation_frames
    return Response(generate_simulation_frames(),
                    mimetype="multipart/x-mixed-replace; boundary=frame")
